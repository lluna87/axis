...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UserSection'
        db.create_table('user_section', (
            ('user_section_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True, db_column='user_section_id')),
        ...
        db.send_create_signal('web', ['UserSection'])

        # Adding unique constraint on 'UserSection', fields ['user_profile', 'section']
        db.create_unique('user_section', ['user_profile_id', 'section_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserSection', fields ['user_profile', 'section']
        db.delete_unique('user_section', ['user_profile_id', 'section_id'])
        ...
        # Deleting model 'UserSection'
        db.delete_table('user_section')
