...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('author', 'image_id')

        # Adding field 'Author.profile_image'
        db.add_column('author', 'profile_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Image'], unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Author.image'
        db.add_column('author', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.Image'], unique=True, null=True),
                      keep_default=False)

        # Deleting field 'Author.profile_image'
        db.delete_column('author', 'profile_image_id')
    ...
    models = {
        ...
        'web.author': {
            ...
            'profile_image': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['web.Image']", 'unique': 'True', 'null': 'True'}),
